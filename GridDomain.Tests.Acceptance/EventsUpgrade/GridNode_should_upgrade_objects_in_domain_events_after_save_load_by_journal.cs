...
namespace GridDomain.Tests.Acceptance.EventsUpgrade
{
    ...
    {
        protected GridNode_should_upgrade_objects_in_domain_events_after_save_load_by_journal(NodeTestFixture fixture) : base(fixture) { }

        public GridNode_should_upgrade_objects_in_domain_events_after_save_load_by_journal(ITestOutputHelper output)
            : this(ConfigureDomain(new NodeTestFixture(output))) { }

        protected static NodeTestFixture ConfigureDomain(NodeTestFixture fixture)
        {
            return fixture.Add(new BalloonDomainConfiguration())
                                              .UseSqlPersistence()
                                              .UseAdaper(new BookOrderAdapter());
        }
