...
namespace GridDomain.Scheduling.Quartz
{
    ...
    {
        public string ConnectionString => "Data Source=(localdb)\\v11.0;Database=Quartz;Integrated Security=true;MultipleActiveResultSets=True;Application Name=Quartz;";
