...
namespace GridDomain.Node.Akka.Configuration.Hocon
{
    public class LogConfig : IHoconConfig
    {
        ...
        public static LogConfig All { get; } = 
            new LogConfig(LogEventLevel.Verbose,true,true,true,true,true,true,true);
                         ...
                         Type logActorType = null)
        {
            ...
            builder.AppendLine($"akka.loggers  = [\"{(logActorType ?? typeof(SerilogLogger)).AssemblyQualifiedShortName()}\"]");
