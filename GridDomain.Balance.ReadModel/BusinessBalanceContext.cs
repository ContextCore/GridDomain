...
namespace GridDomain.Balance.ReadModel
{
    ...
    {
        public static string DefaultConnectionString;// = @"Data Source=(localdb)\v11.0;Initial Catalog=AutoTestGridDomainRead;Integrated Security = true";

        public BusinessBalanceContext(string connectionString):base(connectionString)
        {
            Database.SetInitializer<BusinessBalanceContext>(new CreateDatabaseIfNotExists<BusinessBalanceContext>());
        }
