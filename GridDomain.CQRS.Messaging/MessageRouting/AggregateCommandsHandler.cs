...
namespace GridDomain.CQRS.Messaging.MessageRouting
{
        ...
        where TAggregate : AggregateBase
    {
        ...
        private void Map(AggregateCommandHandler<TAggregate> handler)
        {
            _commandHandlers[typeof (TAggregate)] = handler;
        }
        ...
        {
            Map(AggregateCommandHandler<TAggregate>.New<TCommand>(idLocator, commandExecutor));
        }
