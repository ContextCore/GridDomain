...
namespace GridGomain.Tests.Stress
{
    public class CommandExecutionWithProjectionPerfTest
    {
        ...
        private INodeScenario Scenario { get; } = new BalloonsCreationAndChangeScenario(1, 1);
        ...
        public void Cleanup()
        {
           ...
           // }
           //
           // using (var context = new BallonContext(Fixture.AkkaConfig.Persistence.JournalConnectionString))
           // {
