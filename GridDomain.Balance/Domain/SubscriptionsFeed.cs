...
namespace GridDomain.Balance.Domain
{
    public class SubscriptionsFeed
    {
        ...
        {
            yield return new CreateSubscriptionCommand(Guid.Parse("26F3E274-F486-4B78-A3DA-8ECD321FDFFE"))
            {
            ...
            yield return new CreateSubscriptionCommand(Guid.Parse("4828C630-42A3-4EDF-8835-763F98C80C3D"))
            {
