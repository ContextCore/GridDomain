...
namespace GridDomain.Tests.Unit.CommandsExecution
{
        ...
        BalloonDomainCommandExecutionTests
    {
        ...
        public async Task When_expect_more_than_one_messages()
        {
            ...
            Assert.Contains(_allReceivedMessages, m => m is IMessageMetadataEnvelop<BalloonTitleChanged>);
            Assert.Contains(_allReceivedMessages, m => m is IMessageMetadataEnvelop<BalloonCreated>);
