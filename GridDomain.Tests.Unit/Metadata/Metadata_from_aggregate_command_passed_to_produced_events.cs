...
{
    public class Metadata_from_aggregate_command_passed_to_produced_events : NodeTestKit
    {
        public Metadata_from_aggregate_command_passed_to_produced_events(ITestOutputHelper output) : this(new NodeTestFixture(output)) {}
        protected Metadata_from_aggregate_command_passed_to_produced_events(NodeTestFixture fixture) : base(fixture.Add(new BalloonDomainConfiguration())) {}
